...
window.REPORT_SECTIONS.push(
  {
    ...
    html: `
      ...
      <table class="compare dense">
        ...
        <tr><td>WTA heads</td><td>Winner-Take-All heads in Zak's multimodal configuration. Eight parallel heads each predict a full future and are all compared to the single observed future; annealed soft WTA weights route most gradient to the lowest-loss head for that example/context frame.</td><td>${link(gh.zak, "wayve/ai/experimental/models/mcv_perceiver.py", 3248, "WTA head construction")}; ${link(gh.zak, "wayve/ai/experimental/losses_metrics/common.py", 2155, "WTA weights")}</td></tr>
      </table>
