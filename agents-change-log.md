...
- Topic: PR 102690 merge blocker fixes
  ...
  - Changes:
    ...
    - Added a simpler SI-only `park_mode_blackout_probability` knob, defaulting to `0.0`, that samples between park-mode+blackout and no-park-mode+route-shortening, including explicit support for `p=1.0`.
