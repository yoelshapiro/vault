...
- Changes:
  ...
  - Reworked the Wonjoon Full Architecture graph to reduce line overlap: runtime inputs now merge through a token bus, while training targets and losses are shown in a separate bottom lane.
