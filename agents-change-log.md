...
- Changes:
  ...
  - Confirmed checklist requires core sampling version bumps; retained the reapplied bot commit and advanced the draft versions once more so the event PR owns the next publish step.
  - Diagnosed static-check's stale version baseline, merged latest main, ran the prescribed bump/check commands, and revalidated both dataset suites.
...
- Labels: parking, pudo, sampling, intervention-filters, pr-review.
- Branch: `boris/pudo_generic_materialization`.
- PR: `#117075`.
- Change type: Code cleanup, tests.
- Areas: `wayve/ai/services/sampling/datasets/parking_pudo/intervention_filters.py`; `wayve/ai/services/sampling/datasets/parking_pudo/signals.py`.
- Changes:
...
- Changes:
  ...
  - Observed retry `nautilus-silver-adventurous-189873` pass the 1K gate, then diagnosed a later RouteMapFetcher failure caused by a float route-map index.
...
- PR: none.
- Change type: Training monitoring / external status update.
- Areas: Surfboard job `187902`; W&B run `session_2026_07_02_22_01_25_si_parking_bc_train_release_2026_5_21_frog-eor-d70`; Parking/PUDO model-card table.
- Changes:
  - Monitored job `187902` from early training through W&B `trainer/global_step=1173` while Surfboard remained `Running`.
  - Observed no retry-worthy failure; no code changes or relaunch were needed.
...
- Task note: [[agent_tasks/2026/07/Week-1/2026-07-02-frog-eor-fresh-driving70-1k-monitor|2026-07-02 Frog EOR Fresh Driving70 1K Monitor]]
...
- Labels: parking, pudo, datamodule, route-shortening, training-config, diffusion-config, provenance.
- Branch: `boris/26-06-22-pudo-baseline`.
...
- Changes:
  ...
  - Wired Parking/PUDO provenance stage and current/next gear fields into training provenance extraction, with focused tests.
- Task note: [[agent_tasks/2026/07/Week-27/2026-07-01-pudo-baseline-harlequin-fixes|2026-07-01 PUDO Baseline Harlequin Fixes]]
...
## 2026-08-05 - P2P Event Backfill Validation and PR

- Topic: Convert P2P notebook event detection into a standalone SQL-first materialisation, validate through a month, and publish a draft PR.
