...
| DBW at event start (false) | 2026-04-18 16:58:58.633 | `-19.004s` |
...
| DBW at event end (false) | 2026-04-18 16:59:34.483 | `16.846s` |
...
timeline
    ...
    -19.004s : DBW at event start (false)
    0.000s : Route change unclear
    0.000s : AV engage
    0.000s : DBW -> true
    12.281s : DBW -> false
    12.951s : First motion
    16.846s : DBW at event end (false)
    16.846s : UNPUDO end
```
...
| Success baseline -> event start | `-19.004s` |
| Success baseline -> first motion | `12.951s` |
