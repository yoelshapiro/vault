...
| Driver accel help timestamp | `n/a` |
| Max accel pedal pct in AV | `0.0%` |
| Max brake pedal pct in AV | `22.7%` |
| Max speed mps in AV | `7.494` |
| Route -> AV | `0.007s` |
