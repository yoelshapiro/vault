...
| Actual indicator -> right on | 2026-04-21 11:53:21.869 | `8.201s` |
| Actual indicator -> left on | 2026-04-21 11:53:24.529 | `10.861s` |
| Actual indicator -> off | 2026-04-21 11:53:26.509 | `12.841s` |
| UNPUDO start | 2026-04-21 11:53:36.333 | `22.665s` |
| DBW at event start (true) | 2026-04-21 11:53:36.333 | `22.665s` |
| DBW -> false | 2026-04-21 11:54:00.392 | `46.724s` |
| DBW at event end (true) | 2026-04-21 11:54:32.633 | `78.965s` |
...
timeline
    ...
    8.201s : Actual indicator -> right on
    10.861s : Actual indicator -> left on
    12.841s : Actual indicator -> off
    22.665s : UNPUDO start
    22.665s : DBW at event start (true)
    46.724s : DBW -> false
    78.965s : DBW at event end (true)
    78.965s : UNPUDO end
```
...
| AV -> first motion | `n/a` |
| Success baseline -> event start | `22.665s` |
...
| Foxglove | [segment](https://app.foxglove.dev/wayve-on-prem/p/prj_0dX18KZdVHg1fmmI/view?ds=foxglove-stream&ds.deviceName=fme20032&ds.start=2026-04-21T11%3A59%3A05.118252Z&ds.end=2026-04-21T11%3A59%3A39.533319Z&layoutId=lay_0e7VD4WIKDQGU73Y&time=2026-04-21T11%3A59%3A24.033321Z) |
...
| AV engage | 2026-04-21 11:59:15.122 | `0.004s` |
| DBW -> true | 2026-04-21 11:59:15.122 | `0.004s` |
| Gear change (DRIVE_POSITION_V2_DRIVE) | 2026-04-21 11:59:15.433 | `0.315s` |
| Actual indicator -> right on | 2026-04-21 11:59:21.149 | `6.031s` |
| DBW -> false | 2026-04-21 11:59:23.512 | `8.395s` |
| UNPUDO start | 2026-04-21 11:59:24.033 | `8.915s` |
| DBW at event start (false) | 2026-04-21 11:59:24.033 | `8.915s` |
| Actual indicator -> off | 2026-04-21 11:59:26.729 | `11.611s` |
| DBW at event end (false) | 2026-04-21 11:59:29.533 | `14.415s` |
...
timeline
    ...
    6.031s : Actual indicator -> right on
    8.395s : DBW -> false
    8.915s : UNPUDO start
    8.915s : DBW at event start (false)
    11.611s : Actual indicator -> off
...
| Success timing baseline | `route change` |
| Route -> AV | `0.004s` |
| AV -> event start | `8.911s` |
| AV -> first motion | `n/a` |
| Success baseline -> event start | `8.915s` |
| Success baseline -> first motion | `n/a` |
| AV duration before disengagement | `8.391s` |
| Trajectory waypoint count | `36` |
| Driving-plan step count | `11` |
...
| DBW at event start (false) | 2026-04-21 12:02:35.333 | `1.165s` |
...
| DBW at event end (true) | 2026-04-21 12:02:39.433 | `5.265s` |
...
timeline
    ...
    1.165s : DBW at event start (false)
    1.181s : First motion
    4.644s : AV engage
    4.644s : DBW -> true
    5.265s : DBW at event end (true)
...
| Success baseline -> event start | `1.165s` |
| Success baseline -> first motion | `1.181s` |
