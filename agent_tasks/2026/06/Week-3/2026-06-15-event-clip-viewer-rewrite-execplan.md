...
- [x] (2026-06-15) DECISION (user): keep cache + prefetch for telemetry; accept ~13s first-view per run-day (inherent to `all_data` point lookups), instant after. Did NOT pursue raw-stream tables / bigger warehouse / pre-materialisation.
