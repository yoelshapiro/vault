...
- [ ] User re-test in browser (hard-refresh to bust static cache) — confirm green box appears, browsing is warmer, autoplay no longer blurs, and the 4 telemetry charts render with a moving playhead.
